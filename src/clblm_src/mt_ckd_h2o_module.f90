...
Module mt_ckd_h2o
     ...
     USE read_file
     USE Module_ConstParam,ONLY: RADCN2
...
!
     ...
     ! character(len=*):: fDataname = absco-ref_wv-mt-ckd.nc
     ! character(256):: fDataname = trim(ioFiles%abscoFile)
      character(len=*),parameter :: fDataname = 'clblm_data/spectroscopy/absco-ref_wv-mt-ckd.nc'      ! MT_CKD reference continuum coefficients
